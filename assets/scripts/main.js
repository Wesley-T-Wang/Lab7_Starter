...
const router = new Router(function () {
   ...
   */
  let showRecipeCards = document.querySelector('section.section--recipe-cards');
  showRecipeCards.classList.add('shown');

  let hideRecipeExpand = document.querySelector('section.section--recipe-expand');
  hideRecipeExpand.classList.remove('shown');
...
function bindEscKey() {
   ...
   */
  document.addEventListener('keydown', navHome);
  function navHome(keypress){
